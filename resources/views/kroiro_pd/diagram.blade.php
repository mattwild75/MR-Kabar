...
<html>
<head>
    <title>Diagram Hierarki KRO IRO PD</title>
    <script>
        ...
        <div class="card">
            <div class="card-body">
                <div class="controls mb-3">
                    ...
                    <a href="{{ route('kro_iro_pd.index') }}" target="_top" class="btn btn-secondary mt-2">Lihat Tabel KRO_IRO_PD</a>
                </div>
                ...
                <div class="controls mb-3" style="align-items:center; position:relative; z-index:10000;">
                    <div class="form-group" style="flex:1; min-width:260px;">
                        ...
                        <input type="text" id="hierarchy-search" class="form-control"
                               placeholder="Cari visi, misi, tujuan, sasaran, program, kegiatan, tahap, OPD, risiko... (Enter untuk cari/lanjut)">
                    </div>
                ...
                <div class="legend">
                    ...
                    <div class="legend-item">
                        ...
                        <span>Sasaran RPJMD / Sasaran Strategis PD / Sasaran Renstra</span>
                    </div>
                    <div class="legend-item">
                    ...
                    <div class="legend-item">
                        ...
                        <span>Atribut Risiko (mengikuti urutan kolom tabel, termasuk Tahap)</span>
                    </div>
                </div>
