...
<html>
<head>
    <title>Diagram Hierarki KRS IRS PEMDA</title>
    <script>
        ...
        (function () {
            ...
            // Berubah ketika pengguna mengganti mode di aplikasi induk.
            window.addEventListener('storage', function (e) {
                if (!e || !e.key || e.key === 'appearance') applyAppearance();
            });

            // Berubah ketika tema sistem operasi berganti (mode "system").
...
<body>
        ...
        <div class="card">
            <div class="card-body">
                <div class="controls mb-3">
                    ...
                    {{-- target="_top" — halaman ini dimuat di dalam iframe,
                         jadi navigasi harus keluar dari iframe ke jendela
                         penuh aplikasi (dengan sidebar/layout), bukan
                         berpindah di dalam kotak iframe kecil. --}}
                    <a href="{{ route('krs_irs_pemda.index') }}" target="_top" class="btn btn-secondary mt-2">Lihat Tabel KRS_IRS_Pemda</a>
                </div>
                ...
                <div class="legend">
                    ...
                    <div class="legend-item">
                        ...
                        <span>OPD Penanggung Jawab</span>
                    </div>
                    <div class="legend-item">
    ...
    <script>
        ...
        // Tambahan: trigger perubahan mode total
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Search handler — cari & sorot node lintas seluruh data
            // (termasuk field yang hanya tampil di popup detail node).
            ...
            // Print handler — cetak seluruh diagram dalam satu halaman,
            // di-scale otomatis agar pas (fit-to-page).
