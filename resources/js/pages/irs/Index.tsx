...
const BAGIAN_FORM: Partial<Record<FieldName, string>> = {
    'SASARAN RPJMD': 'Identitas Risiko',
...
// diduplikasi persis di ~10 file lain — irs_pd/iro_pd/dashboard/dst).
const skalaBadgeClass = riskLevelClassNameWithHover;

export default function IrsIndex({
    rows,
    fieldOptions,
    opdOptions,
    opdList,
        ...
        if (editing) {
            ...
            post('/irs_pemda', {
                onSuccess: (halaman) => {
                    ...
                    unggahTertunda('irs_pemda', (halaman?.props as { flash?: { createdRiskId?: number } })?.flash?.createdRiskId);
                },
            ...
            <div className="space-y-4 p-4">
                <div className="flex items-start justify-between gap-4">
                  ...
                  ikut mengubah tahun aktif seluruh Pemda. */}
                            <OpdPicker routeName="/irs_pemda" options={opdSaringanOptions} nilai={opdId} tambahan={{ tahun: tahun ?? 'semua' }} />
                            <PeriodeTahunPicker
                                routeName="/irs_pemda"
                                jenis="tahun"
