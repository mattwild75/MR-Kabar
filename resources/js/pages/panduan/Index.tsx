 ...
 */
export default function PanduanIndex({ bolehLihatRekap = false, rekapKuis = null }: { bolehLihatRekap?: boolean; rekapKuis?: RekapKuis | null }) {
    ...
    return (
        <AppLayout>
            ...
            <div className="flex gap-6 p-4">
                ...
                <nav className="bg-card sticky top-4 hidden h-fit w-64 shrink-0 space-y-1 rounded-md border p-3 text-sm lg:block">
                ...
                <div className="min-w-0 flex-1 space-y-4">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-1 text-sm">
                            ...
                            diperbarui seiring pengembangan aplikasi.
                        </p>
                    </div>
              ...
              menyaring bagian sesuai perannya, dan menguji pemahamannya. */}
                    {video.enabled && (
                        <section id="video-edukasi" className="bg-card scroll-mt-20 rounded-md border p-5">
                    ...
                    {tutorial.enabled && (
                        <section id="video-tutorial" className="bg-card scroll-mt-20 rounded-md border p-5">
                            ...
                            <p className="mb-4 rounded-md border border-amber-500/60 bg-amber-50 p-3 text-sm text-amber-900 dark:bg-amber-950/30 dark:text-amber-200">
                                ...
                                keadaan sebenarnya, tetapi tetap contoh. Untuk pengisian yang sesungguhnya, setiap pernyataan risiko, penyebab, dan
                                angka skala dikembalikan kepada pertimbangan penilai risiko masing-masing melalui PIC atau unit pemilik risiko di
