        ...
        <table className="mt-3 w-full table-fixed border-collapse border border-black text-[10px]">
            ...
            <thead>
                <tr className="bg-muted/40">
                    ...
                    <th colSpan={2} className="border border-black p-1 text-center font-semibold">
                        Sebab
                    </th>
                    <th rowSpan={2} className="border border-black p-1 align-middle font-semibold">
                        C / UC
            ...
            <tbody>
                {entries.length === 0 && (
                    <tr>
                        <td colSpan={totalKolom} className="text-muted-foreground border border-black p-2 text-center">
        ...
        <AppLayout>
            ...
            <div className="space-y-4 p-4 print:hidden">
                <div>
                    ...
                    {isScopedToOwnOpd && <p className="text-muted-foreground mt-1 text-xs">Data lintas-OPD hanya bisa dilihat Admin/Super Admin.</p>}
                </div>
            ...
            <div className="cee-print-sheet mx-auto max-w-[1500px] bg-white p-8 text-black print:m-0 print:max-w-none print:p-0 print:shadow-none">
                ...
                <div className="text-muted-foreground mt-2 text-[9px] leading-tight">
                    <p>Keterangan:</p>
                    ...
                    <p>
                        Kolom g diisi dengan penyebab timbulnya risiko. Untuk mempermudah identifikasi sebab risiko, sebab risiko bisa dikategorikan
                        ke dalam: Men, Machine, Method, Material, Money, Management, Measurement, dan Environment (7M+1E) untuk sebab Internal, atau
                        Political, Economic, Social, Technological, Legal, dan Environmental (PESTLE) untuk sebab Eksternal.
                    </p>
                    ...
                    <p>
                        Kolom j diisi dengan uraian akibat yang ditimbulkan jika risiko benar-benar terjadi. Untuk mempermudah identifikasi dampak
                        risiko, dampak risiko bisa dikategorikan ke dalam 5 area sesuai kriteria penilaian dampak: Kerugian Negara/Daerah, Penurunan
                        Reputasi, Penurunan Kinerja, Gangguan terhadap Pelayanan, dan Jumlah Tuntutan Hukum.
                    </p>
                    <p>Kolom k diisi dengan pihak/unit yang menderita/terkena dampak jika risiko benar-benar terjadi.</p>
                    <p>
                        Indikator kinerja tujuan strategis ditampilkan di kolom b (bersama label Tujuan Strategis), sedangkan kolom c khusus indikator
