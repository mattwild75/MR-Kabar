    ...
    return (
        <AppLayout>
            ...
            <div className="space-y-4 p-4 print:hidden">
                <div>
                    <h1 className="text-xl font-semibold tracking-tight md:text-2xl">2b_Konteks Risiko Strategis OPD</h1>
                ...
                <div className="flex flex-wrap items-end justify-between gap-3">
                    ...
                    {opd && <UnduhPdfButton href={`/cetak/risiko/2b/pdf?opd_id=${opd.id}&tahun=${tahun}`} />}
                </div>
            </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td className="border border-black p-1.5 align-top">
                                    ...
                                    <p className="text-muted-foreground mt-1 text-[10px] italic">
                                        *Ket. yang dicetak Tebal : IK dipilih sebagai IKU dan Sasaran yang dipilih sebagai Penetapan Konteks Risiko
                                        Strategis OPD
                                    </p>
                                </td>
                            </tr>
