    ...
    return (
        <table className="mt-3 w-full table-fixed border-collapse border border-black text-[10px]">
            ...
            {sectionDefs.every((s) => sections[s.key].length === 0) && (
                <tbody>
                    <tr>
                        <td colSpan={9} className="text-muted-foreground border border-black p-2 text-center">
...
export default function Cetak7({ tahun, periode, sections, pemerintahKabkota, isScopedToOwnOpd, isAdmin, opdOptions, opdId, dataUmum }: PageProps) {
    const navigate = (nextTahun: number) => {
        router.get('/cetak/risiko/7', { opd_id: opdId ?? undefined, tahun: nextTahun }, { preserveState: true, preserveScroll: true, replace: true });
    };
    ...
    return (
        <AppLayout>
            ...
            <div className="cee-print-sheet mx-auto max-w-[1500px] bg-white p-8 text-black print:m-0 print:max-w-none print:p-0 print:shadow-none">
                ...
                <div className="keterangan-form7 text-muted-foreground mt-2 text-[9px] leading-tight">
                    <p>Keterangan:</p>
                    <p>Kolom a diisi dengan nomor urut.</p>
                    <p>
                        Kolom b diisi dengan nama Perangkat Daerah pemilik risiko — di luar kolom baku Perdep, ditambahkan krn Form ini menggabungkan
                        seluruh OPD sekaligus.
                    </p>
                    <p>Kolom c diisi dengan risiko prioritas.</p>
                    <p>Kolom d diisi dengan kode risiko.</p>
                    <p>
                        Kolom e diisi dengan uraian pengendalian-pengendalian yang sudah ada/ terpasang, disertai kategori E (Efektif)/KE (Kurang
                        Efektif)/TE (Tidak Efektif). Agar diungkap tidak hanya nama SOP nya, Contoh SOP Pemeliharaan: Gedung dibersihkan 2 kali
                        sehari.
                    </p>
                    <p>
                        Kolom f Diisi dengan alasan tidak efektif: (1) Kebijakan dan Prosedur pengendalian sudah dilakukan, namun belum mampu
                        menangani risiko yang teridentifikasi, (2) Prosedur pengendalian belum/tidak dapat dilaksanakan, (3) Kebijakan belum diikuti
                        dengan prosedur baku yang jelas, (4) Kebijakan dan prosedur yang ada tidak sesuai dengan peraturan diatasnya.
                    </p>
                    ...
                    <p>
                        Form ini mencakup risiko dengan kriteria Prioritas (Tinggi/Sangat Tinggi) dari Risiko Strategis Pemda, Risiko Strategis OPD,
                        dan Risiko Operasional OPD.
                    </p>
                </div>
