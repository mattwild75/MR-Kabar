        ...
        <AppLayout>
            ...
            <div className="space-y-4 p-4 print:hidden">
                ...
                <div className="flex flex-wrap items-end justify-between gap-3">
                    ...
                    {opd && <UnduhPdfButton href={`/cetak/risiko/3c/pdf?opd_id=${opd.id}&tahun=${tahun}`} />}
                </div>
            </div>
            ...
            {opd && identifikasi && (
                <div className="cee-print-sheet mx-auto max-w-[1500px] bg-white p-8 text-black print:m-0 print:max-w-none print:p-0 print:shadow-none">
                    ...
                    <div className="text-muted-foreground mt-2 text-[9px] leading-tight">
                        ...
                        <p>
                            Kolom j diisi dengan C, jika unit kerja mampu untuk mengendalikan penyebab risiko, atau UC jika unit kerja tidak mampu
                            mengendalikan penyebab risiko.
                        </p>
                        <p>
                            Kolom k diisi dengan uraian akibat yang ditimbulkan jika risiko benar-benar terjadi. Untuk mempermudah identifikasi dampak
