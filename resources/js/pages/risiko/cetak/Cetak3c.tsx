      ...
      {opd && identifikasi && (
        <div className="cee-print-sheet mx-auto max-w-[1500px] bg-white p-8 text-black print:m-0 print:max-w-none print:p-0 print:shadow-none">
          ...
          <div className="mt-2 text-[9px] leading-tight text-muted-foreground">
            ...
            <p>Kolom k diisi dengan uraian akibat yang ditimbulkan jika risiko benar-benar terjadi. Untuk mempermudah identifikasi dampak risiko, dampak risiko bisa dikategorikan ke dalam 5 area sesuai kriteria penilaian dampak: Kerugian Negara/Daerah, Penurunan Reputasi, Penurunan Kinerja, Gangguan terhadap Pelayanan, dan Jumlah Tuntutan Hukum.</p>
