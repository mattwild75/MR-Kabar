    ...
    return (
        <AppLayout>
            ...
            <div className="space-y-4 p-4 print:hidden">
                <div>
                    <h1 className="text-xl font-semibold tracking-tight md:text-2xl">2c_Konteks Risiko Operasional OPD</h1>
                ...
                <div className="flex flex-wrap items-end justify-between gap-3">
                    ...
                    {opd && <UnduhPdfButton href={`/cetak/risiko/2c/pdf?opd_id=${opd.id}&tahun=${tahun}`} />}
                </div>
            </div>
                        ...
                        <tbody>
                            <tr>
                                <td className="w-56 border border-black p-1.5 align-top font-semibold">
                                    Kegiatan (Output/Keluaran) / Hasil Kegiatan
                                </td>
                                <td className="w-4 border border-black p-1.5 text-center align-top">:</td>
                                <td className="border border-black p-1.5 align-top">
