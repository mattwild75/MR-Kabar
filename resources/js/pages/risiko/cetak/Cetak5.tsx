...
import { KATEGORI_5M_WARNA, KategoriText } from './Cetak3a';
    ...
    return (
        <table className="mt-3 w-full table-fixed border-collapse border border-black text-[10px]">
            ...
            {sectionDefs.every((s) => sections[s.key].length === 0) && (
                <tbody>
                    <tr>
                        <td colSpan={8} className="text-muted-foreground border border-black p-2 text-center">
        ...
        <AppLayout>
            ...
            <div className="space-y-4 p-4 print:hidden">
                ...
                <div className="flex flex-wrap items-end justify-between gap-3">
                    ...
                    <UnduhPdfButton href={`/cetak/risiko/5/pdf?tahun=${tahun}`} />
                </div>
            </div>
            ...
            <div className="cee-print-sheet mx-auto max-w-[1500px] bg-white p-8 text-black print:m-0 print:max-w-none print:p-0 print:shadow-none">
                ...
                <div className="keterangan-form5 text-muted-foreground mt-2 text-[9px] leading-tight">
                    <p>Keterangan:</p>
                    ...
                    <p>
                        Risiko prioritas = risiko dengan kriteria &quot;Tinggi&quot; dan &quot;Sangat Tinggi&quot; sesuai Perdep PPKD No.4/2019 Bab
                        III.C, batas skala mengikuti pengaturan Level Risiko (Settings &gt; Keterangan Pendukung).
                    </p>
                </div>
            </div>
