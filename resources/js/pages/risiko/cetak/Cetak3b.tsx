    ...
    return (
        <AppLayout>
            ...
            <div className="space-y-4 p-4 print:hidden">
                <div>
                    <h1 className="text-xl font-semibold tracking-tight md:text-2xl">3b_Identifikasi Risiko Strategis OPD</h1>
                ...
                <div className="flex flex-wrap items-end justify-between gap-3">
                    ...
                    {opd && <UnduhPdfButton href={`/cetak/risiko/3b/pdf?opd_id=${opd.id}&tahun=${tahun}`} />}
                </div>
            </div>
                ...
                <div className="cee-print-sheet mx-auto max-w-[1500px] bg-white p-8 text-black print:m-0 print:max-w-none print:p-0 print:shadow-none">
                    ...
                    <div className="text-muted-foreground mt-2 text-[9px] leading-tight">
                        ...
                        <p>
                            ...
                            dikategorikan ke dalam: Men, Machine, Method, Material, Money, Management, Measurement, dan Environment (7M+1E) untuk
                            sebab Internal, atau Political, Economic, Social, Technological, Legal, dan Environmental (PESTLE) untuk sebab Eksternal.
                        </p>
                        ...
                        <p>
                            ...
                            risiko, dampak risiko bisa dikategorikan ke dalam 5 area sesuai kriteria penilaian dampak: Kerugian Negara/Daerah,
                            Penurunan Reputasi, Penurunan Kinerja, Gangguan terhadap Pelayanan, dan Jumlah Tuntutan Hukum.
                        </p>
                        <p>Kolom k diisi dengan pihak/unit yang menderita/terkena dampak jika risiko benar-benar terjadi.</p>
                        <p>
                            Indikator kinerja tujuan strategis ditampilkan di kolom b (bersama label Tujuan Strategis), sedangkan kolom c khusus
