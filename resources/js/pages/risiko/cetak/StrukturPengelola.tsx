            ...
            <div className="space-y-4 p-4">
                <div className="flex flex-wrap items-center justify-between gap-3 print:hidden">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        <Select value={String(tahun)} onValueChange={(v) => router.get('/cetak/struktur-pengelolaan-risiko', { tahun: v })}>
            ...
            orang memutuskan siapa mengisi peran apa. */}
                <div className="bg-muted/40 rounded-md border p-3 text-sm print:hidden">
                    ...
                    <p className="text-muted-foreground mt-1">
                        Lampiran 2 memuat contoh Keputusan Kepala Daerah tentang struktur pengelolaan Risiko, dan Lampiran 3 menyebut susunannya:{' '}
                        <strong>Sekretaris Daerah</strong> sebagai koordinator penyelenggaraan; <strong>Kepala Daerah</strong> sebagai Unit Pemilik
                        Risiko tingkat Pemerintah Daerah, dengan pejabat eselon sebagai Unit Pemilik Risiko di tingkatnya;{' '}
                        <strong>Komite Pengelolaan Risiko</strong> tingkat Pemerintah Daerah; <strong>Asisten Sekretaris Daerah</strong> sebagai Unit
                        Kepatuhan; dan <strong>Inspektur Daerah</strong> sebagai penanggung jawab pengawasan.
                    </p>
                    <p className="text-muted-foreground mt-1">
                        Susunan ini bukan sekadar naskah cetak. Karena tersimpan sebagai data, aplikasi dapat merujuknya — blok tanda tangan Laporan
                        14 Pembinaan Komite mengambil pejabat berperan Komite dari tahun berjalan. Nama boleh dikosongkan bila jabatannya lowong;
                        naskah tetap dapat dicetak dengan jabatannya saja.
                    </p>
                </div>
                ...
                {rows.length === 0 ? (
                    ...
                    <div className="mx-auto w-full max-w-4xl bg-white p-8 text-black shadow-sm dark:bg-white print:shadow-none">
                                ...
                                {rows.map((r, i) => (
                                    <tr key={r.id}>
                                        ...
                                        <td className="border border-black p-1 align-top font-medium">
                                            {r.peran_label}
                                            {r.kedudukan_label && <span className="block font-normal italic">{r.kedudukan_label}</span>}
