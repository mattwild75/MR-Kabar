    ...
    return (
        <table className="mt-3 w-full table-fixed border-collapse border border-black text-[10px]">
            ...
            {sectionDefs.every((s) => sections[s.key].length === 0) && (
                <tbody>
                    <tr>
                        <td colSpan={7} className="text-muted-foreground border border-black p-2 text-center">
                        ...
                        {rows.map((r, i) => (
                            <tr key={`${section.key}-${i}`}>
                                ...
                                <td className="border border-black p-1 text-center align-top">
                                    <span
                                        className={`inline-block w-full rounded px-1 py-0.5 text-center font-semibold ${skalaBadgeClass(r.skala_risiko, riskLevels)}`}
                                    >
                                        {r.skala_risiko ?? '-'}
                                    </span>
                                </td>
        ...
        <AppLayout>
            ...
            <div className="space-y-4 p-4 print:hidden">
                ...
                <div className="flex flex-wrap items-end justify-between gap-3">
                    ...
                    <UnduhPdfButton href={`/cetak/risiko/4/pdf?tahun=${tahun}`} />
                </div>
            </div>
            ...
            <div className="cee-print-sheet mx-auto max-w-[1500px] bg-white p-8 text-black print:m-0 print:max-w-none print:p-0 print:shadow-none">
                ...
                <div className="keterangan-form4 text-muted-foreground mt-2 text-[9px] leading-tight">
                    <p>Keterangan:</p>
                    ...
                    <p>
                        Kolom f diisi dengan skala kemungkinan berdasarkan perhitungan rata-rata/modus skala kemungkinan yang diberikan peserta
                        diskusi.
                    </p>
                    <p>Kolom g diisi dengan hasil perkalian antara skala dampak dan skala kemungkinan.</p>
                </div>

                <div className="matriks-analisis-risiko border-muted-foreground/20 mt-6 border-t-8 border-dashed pt-6 print:border-t-0 print:pt-0">
