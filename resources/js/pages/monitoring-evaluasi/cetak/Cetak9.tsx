    ...
    return (
        <AppLayout>
            ...
            <div className="space-y-4 p-4 print:hidden">
                <div>
                    <h1 className="text-xl font-semibold tracking-tight md:text-2xl">9_Rencana &amp; Realisasi Pemantauan</h1>
                ...
                <div className="flex flex-wrap items-end justify-between gap-3">
                    ...
                    {opd && <UnduhPdfButton href={`/cetak/monitoring-evaluasi/9/pdf?opd_id=${opd.id}&tahun=${tahun}`} />}
                </div>
            </div>
                    ...
                    {rows.some((r) => r.skala_risiko_aktual !== null) && (
                        <div className="mt-2 text-[9px] leading-tight">
                            <p className="font-semibold">
                                Hasil Re-assessment Risiko (Skala Aktual) — informasi tambahan, bukan bagian format baku Perdep:
                            </p>
