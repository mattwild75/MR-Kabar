    ...
    <AppLayout>
      ...
      <div className="space-y-4 p-4 print:hidden">
        ...
        <div className="flex flex-wrap items-end justify-between gap-3">
          ...
          {opd && (
            <UnduhPdfButton href={`/cetak/monitoring-evaluasi/10/pdf?opd_id=${opd.id}&tahun=${tahun}`} />
          )}
        </div>
      </div>
      ...
      {opd && (
        <div className="cee-print-sheet mx-auto max-w-[1500px] bg-white p-8 text-black print:m-0 print:max-w-none print:p-0 print:shadow-none">
          ...
          <div className="mt-2 text-[9px] leading-tight text-muted-foreground">
            ...
            <p>Kolom d diisi dengan penyebab peristiwa risiko saat terjadi pada tahun berjalan, dikategorikan 7M+1E (Men/Machine/Method/Material/Money/Management/Measurement/Environment) untuk sebab Internal, atau PESTLE (Political/Economic/Social/Technological/Legal/Environmental) untuk sebab Eksternal.</p>
