    ...
    return (
        <AppLayout>
            ...
            <div className="space-y-4 p-4 print:hidden">
                <div>
                    <h1 className="text-xl font-semibold tracking-tight md:text-2xl">10_Pencatatan Kejadian Risiko &amp; Pelaksanaan RTP</h1>
                ...
                <div className="flex flex-wrap items-end justify-between gap-3">
                    ...
                    {opd && <UnduhPdfButton href={`/cetak/monitoring-evaluasi/10/pdf?opd_id=${opd.id}&tahun=${tahun}`} />}
                </div>
            </div>
            ...
            {opd && (
                <div className="cee-print-sheet mx-auto max-w-[1500px] bg-white p-8 text-black print:m-0 print:max-w-none print:p-0 print:shadow-none">
                    ...
                    <h2 className="mt-2 text-center text-sm font-bold uppercase">Pencatatan Kejadian Risiko (Risk Event) dan Pelaksanaan RTP</h2>
                    ...
                    <div className="text-muted-foreground mt-2 text-[9px] leading-tight">
                        ...
                        <p>
                            Kolom c diisi dengan tanggal terjadinya risiko pada tahun berjalan — &quot;Tidak Terjadi&quot; bila risiko belum terjadi.
                        </p>
                        <p>
                            Kolom d diisi dengan penyebab peristiwa risiko saat terjadi pada tahun berjalan, dikategorikan 7M+1E
                            (Men/Machine/Method/Material/Money/Management/Measurement/Environment) untuk sebab Internal, atau PESTLE
                            (Political/Economic/Social/Technological/Legal/Environmental) untuk sebab Eksternal.
                        </p>
