...
function SasaranPdRow({
    ...
    registerRef,
    riskLevels,
}: { group: SasaranPdGroup } & TreeCommonProps) {
    ...
    return (
        <AppLayout>
            ...
            <div className="space-y-4 p-4">
                <div>
                    <h1 className="text-xl font-semibold tracking-tight md:text-2xl">KRS_IRS_PD</h1>
                ...
                <RiskSummaryCard
                    groups={riskSummaryGroups}
                    riskLevels={riskLevels}
                    title="Rangkuman Risiko per Sasaran Renstra PD"
                    outcomeLabel="Kegiatan"
                />
                ...
                {!activeQuery && <p className="text-muted-foreground text-sm">Menampilkan {totalSubkegiatans} subkegiatan.</p>}
                    ...
                    {allGroups.length > 0 ? (
                        ...
                        <div className="rounded-md border">
                            <EmptyState
                                ...
                                description="Tabel gabungan terisi otomatis dari KRS dan IRS PD yang sudah diisi pada tahun ini."
                            />
                        </div>
                    )}
                </div>
