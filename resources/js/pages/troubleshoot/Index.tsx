        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex-1 p-4 md:p-6">
                <Card>
                    <CardHeader>
                        ...
                        <p className="text-muted-foreground text-sm">Laporan kendala, bug, dan saran dari pengguna. Total: {reports.total}.</p>
                    </CardHeader>
                    <CardContent>
                        {/* Filter */}
                        <div className="mb-4 flex flex-wrap items-end gap-3">
                            <div className="min-w-[200px] flex-1">
                                ...
                                >
                                    <Input placeholder="Cari subjek / deskripsi..." value={search} onChange={(e) => setSearch(e.target.value)} />
                                ...
                                <tbody>
                                    ...
                                    {reports.data.map((r) => (
                                        <tr key={r.id} className="hover:bg-muted/30 border-t">
                                            ...
                                            <td className="text-muted-foreground p-3 whitespace-nowrap">{r.created_at}</td>
                                            <td className="p-3">
            ...
            <Dialog open={!!detail} onOpenChange={(o) => !o && setDetail(null)}>
                <DialogContent className="sm:max-w-lg">
                    ...
                    <div className="text-sm leading-relaxed whitespace-pre-wrap">{detail?.description}</div>
                </DialogContent>
            </Dialog>
        </AppLayout>
    );
