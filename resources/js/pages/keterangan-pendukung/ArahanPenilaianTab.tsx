 ...
 * karangan aplikasi.
 */
export default function ArahanPenilaianTab({
  rows,
  jenisLabel,
}: {
  rows: ArahanRow[];
  ...
  const simpanTahapan = () => {
    ...
    const selesai = {
      ...
      onError: (errs: Record<string, string>) =>
        toast.error(errs.tanggal_selesai ?? errs.tahapan ?? 'Gagal menyimpan tahapan.'),
      onFinish: () => setProcessing(false),
      preserveScroll: true,
    };
  ...
  return (
    <div className="space-y-4">
      <div className="bg-muted/40 rounded-md border p-3 text-sm">
        <p>
          Rekam Surat Edaran Bupati tentang <strong>Arahan dan Kebijakan Penilaian Risiko</strong> beserta tahapan
          dan tenggatnya. Yang 5 tahunan mengikuti periode RPJMD; yang 1 tahunan mengikuti siklus anggaran dan
          memuat tanggal konkret.
        </p>
        <p className="text-muted-foreground mt-1">
          Tahapan pada arahan berstatus <strong>Berlaku</strong> menjadi sumber jadwal yang tampil di Dasbor.
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          Seluruh tahapan di dalamnya ikut terhapus, dan jadwal pada Dasbor tidak lagi
                          menampilkannya.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground text-xs">
                Dokumen perencanaan yang memicu tahapan ini. Perdep menyatakan tenggat penilaian risiko relatif
                terhadap dokumen tersebut, misalnya dua minggu setelah RKA OPD disusun.
              </p>
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1">
