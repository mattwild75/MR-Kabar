...
export default function KeteranganPendukungIndex({
    tab,
    kriteriaDampak,
    kriteriaKemungkinan,
    matrixCells,
            ...
            <div className="space-y-4 p-4">
                <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                        ...
                        Perubahan di sini langsung berlaku di seluruh form terkait.
                    </p>
                </div>
                    ...
                    {TABS.map((t) => (
                        <button
                            ...
                            className={`rounded-md px-3 py-1.5 text-sm font-medium transition-colors ${
                                activeTab === t.id ? 'text-foreground bg-sky-500/15 ring-1 ring-sky-500/30' : 'text-muted-foreground hover:bg-muted'
                            }`}
                        >
                            {t.label}
                        </button>
                ...
                {activeTab === 'arahan_penilaian' && <ArahanPenilaianTab rows={arahanPenilaian} jenisLabel={jenisArahanLabel} />}
        ...
        <div className="overflow-x-auto rounded-md border">
            <table className="min-w-full text-sm">
                ...
                <tbody>
                    {rows.map((row) => (
                        <tr key={row.id}>
                            <td className="border px-3 py-2 text-center align-top">{row.level}</td>
                            <td className="border px-3 py-2 align-top">{row.label}</td>
                            <td className="max-w-xs border px-3 py-2 align-top">{row.kerugian_negara}</td>
                            <td className="max-w-xs border px-3 py-2 align-top">{row.penurunan_reputasi}</td>
                            <td className="max-w-xs border px-3 py-2 align-top">{row.penurunan_kinerja}</td>
                            <td className="max-w-xs border px-3 py-2 align-top">{row.gangguan_pelayanan}</td>
                            <td className="max-w-xs border px-3 py-2 align-top">{row.tuntutan_hukum}</td>
                ...
                <DialogContent className="max-h-[90vh] max-w-2xl overflow-y-auto">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="space-y-1">
                            ...
                            <Textarea
                                rows={2}
                                value={form.kerugian_negara ?? ''}
                                onChange={(e) => setForm((f) => ({ ...f, kerugian_negara: e.target.value }))}
                            />
                        </div>
                        <div className="space-y-1">
                            ...
                            <Textarea
                                rows={2}
                                value={form.penurunan_reputasi ?? ''}
                                onChange={(e) => setForm((f) => ({ ...f, penurunan_reputasi: e.target.value }))}
                            />
                        </div>
                        <div className="space-y-1">
                            ...
                            <Textarea
                                rows={2}
                                value={form.penurunan_kinerja ?? ''}
                                onChange={(e) => setForm((f) => ({ ...f, penurunan_kinerja: e.target.value }))}
                            />
                        </div>
                        <div className="space-y-1">
                            ...
                            <Textarea
                                rows={2}
                                value={form.gangguan_pelayanan ?? ''}
                                onChange={(e) => setForm((f) => ({ ...f, gangguan_pelayanan: e.target.value }))}
                            />
                        </div>
                        <div className="space-y-1">
                            ...
                            <Textarea
                                rows={2}
                                value={form.tuntutan_hukum ?? ''}
                                onChange={(e) => setForm((f) => ({ ...f, tuntutan_hukum: e.target.value }))}
                            />
                        </div>
                    </div>
                    <DialogFooter>
                ...
                <tbody>
                    {rows.map((row) => (
                        <tr key={row.id}>
                            ...
                            <td className="max-w-xs border px-3 py-2 align-top">{row.probabilitas}</td>
                            <td className="max-w-xs border px-3 py-2 align-top">{row.frekuensi}</td>
                            <td className="max-w-xs border px-3 py-2 align-top">{row.toleransi}</td>
                            <td className="border px-3 py-2 align-top">
                                <Button variant="ghost" size="icon" onClick={() => openEdit(row)}>
                                    <Edit className="h-4 w-4" />
                                </Button>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="space-y-1">
                            ...
                            <Textarea
                                ...
                                onChange={(e) => setForm((f) => ({ ...f, probabilitas: e.target.value }))}
                            />
                        </div>
                        <div className="space-y-1">
    ...
    return (
        <div>
          ...
          menduplikasi seluruh perhitungan tepinya. */}
            <div className="bg-muted/40 mb-3 rounded-md border p-3 text-sm [--batas-selera:#b91c1c] dark:[--batas-selera:#fca5a5]">
                <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
                    <span aria-hidden className="inline-block h-0 w-12 border-t-[9px] border-dashed" style={{ borderColor: 'var(--batas-selera)' }} />
                        ...
                        {[5, 4, 3, 2, 1].map((kemungkinan) => (
                            <tr key={kemungkinan}>
                                ...
                                {[1, 2, 3, 4, 5].map((dampak) => {
                                    ...
                                    if (!cell)
                                        return (
                                            <td key={dampak} className="border px-3 py-2">
                                                -
                                            </td>
                                        );
          ...
          Program Bupati, dan Form Cetak. */}
            <div className="bg-muted/40 mb-3 rounded-md border p-3 text-sm">
                ...
                <p className="text-muted-foreground mt-1">
                    Centang kolom <strong>Melampaui Selera</strong> pada level yang sudah di luar selera Risiko Pemerintah Kabupaten Aceh Barat.
                    Risiko pada level bercentang ditetapkan sebagai <strong>Risiko Prioritas</strong>, dan garis putus-putus pada tab{' '}
                    ...
                    <tbody>
                        {rows.map((row) => (
                            <tr key={row.id}>
                                ...
                                <td className="border px-3 py-2 text-center align-top">{row.skala_min}</td>
                                <td className="border px-3 py-2 text-center align-top">{row.skala_max}</td>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="space-y-1">
                                ...
                                <Input
                                    ...
                                    min={1}
                                    max={25}
                                    value={form.skala_min ?? ''}
                                    onChange={(e) => setForm((f) => ({ ...f, skala_min: Number(e.target.value) }))}
                                />
                            </div>
                            <div className="space-y-1">
                                ...
                                <Input
                                    ...
                                    min={1}
                                    max={25}
                                    value={form.skala_max ?? ''}
                                    onChange={(e) => setForm((f) => ({ ...f, skala_max: Number(e.target.value) }))}
                                />
                            </div>
                        </div>
                        <div className="space-y-1">
                        ...
                        <div className="flex items-start gap-2 rounded-md border p-3">
                            ...
                            <Label htmlFor="melampaui_selera" className="cursor-pointer text-sm leading-snug font-normal">
                                ...
                                <span className="text-muted-foreground block">
                                    Risiko yang jatuh pada level ini menjadi Risiko Prioritas, dan letak garis batas pada matriks ikut menyesuaikan.
                                </span>
                            </Label>
                        </div>
                    </div>
                    ...
                    <tbody>
                        {rows.map((row) => (
                            <tr key={row.id}>
                                ...
                                <td className="border px-3 py-2 text-center align-top">{row.urutan}</td>
                                <td className="border px-3 py-2 align-top">
                                        ...
                                        <AlertDialog>
                                            ...
                                            <AlertDialogContent>
                                                <AlertDialogHeader>
                                                    ...
                                                    <AlertDialogDescription>
                                                        "{row.kode} - {row.nama}" akan dihapus permanen.
                                                    </AlertDialogDescription>
                                                </AlertDialogHeader>
                                                <AlertDialogFooter>
    ...
    return (
        <div>
            <div className="mb-3 flex items-center justify-between gap-2">
                <p className="text-muted-foreground text-sm">
                    Daftar OPD ini dipakai combobox "Unit/OPD Penanggung Jawab Pengendalian" di seluruh form IRS/IRO. Berhati-hatilah menghapus OPD
                    yang sudah dipakai di data existing.
                    <br />
                    Total: <span className="text-foreground font-semibold">{rows.length} OPD</span>
                </p>
            ...
            <div className="overflow-x-auto rounded-md border">
                <table className="min-w-full text-sm">
                    <thead className="bg-muted/50">
                        <tr>
                            <th className="w-12 border px-3 py-2 text-left font-semibold">No</th>
                    ...
                    <tbody>
                        {rows.map((row, index) => (
                            <tr key={row.id}>
                                <td className="text-muted-foreground border px-3 py-2 align-top">{index + 1}</td>
                                <td className="border px-3 py-2 align-top">{row.nama}</td>
                                <td className="border px-3 py-2 align-top">
                                    <div className="flex gap-1">
                                        <Button variant="ghost" size="icon" onClick={() => openEdit(row)}>
    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between gap-2">
                <p className="text-muted-foreground text-sm">
                    Tabel 3.7 RPJM Kabupaten Aceh Barat Tahun 2025-2029 — 100 Program Pembangunan Pemerintah Kabupaten Aceh Barat, dikelompokkan per
                    Misi. Visi &amp; Misi diambil LIVE dari data KRS Pemda (I_a) — mengedit Visi/Misi di sana otomatis ikut memperbarui tampilan di
                    tab ini.
                    <br />
                    Total: <span className="text-foreground font-semibold">{rows.length} / 100 Program</span>
                </p>
                <Button onClick={openCreate} className="shrink-0">
                    <Plus className="mr-2 h-4 w-4" />
                    Tambah Program
            ...
            <div className="bg-muted/30 rounded-md border p-3 text-sm">
                <span className="text-foreground font-semibold">Visi:</span>{' '}
                {visiMisiPemda.visi ?? <span className="text-muted-foreground italic">Belum diisi di KRS Pemda (I_a)</span>}
            </div>

            {grouped.map((g) => (
                <div key={g.urutan} className="space-y-2">
                    <p className="text-foreground rounded-md bg-sky-500/10 px-3 py-1.5 text-sm font-semibold ring-1 ring-sky-500/20">
                        ...
                        <table className="min-w-full text-sm">
                            <thead className="bg-muted/50">
                                <tr>
                                    ...
                                    <th className="w-20 border px-3 py-2 text-left font-semibold">Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
                                {g.rows.map((row) => (
                                    <tr key={row.id}>
                                        <td className="text-muted-foreground border px-3 py-2 align-top">{row.nomor}</td>
                                                ...
                                                <AlertDialog>
                                                    ...
                                                    <AlertDialogContent>
                                                        <AlertDialogHeader>
                                                            ...
                                                            <AlertDialogDescription>
                                                                "{row.program_pembangunan}" akan dihapus permanen.
                                                            </AlertDialogDescription>
                                                        </AlertDialogHeader>
                                                        <AlertDialogFooter>
                                                            <AlertDialogCancel>Batal</AlertDialogCancel>
                ...
                <DialogContent className="max-h-[85vh] max-w-2xl overflow-y-auto">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="space-y-1">
                            ...
                            <Textarea rows={2} value={form.branding ?? ''} onChange={(e) => setForm((f) => ({ ...f, branding: e.target.value }))} />
                        </div>
                        <div className="space-y-1">
                            ...
                            <p className="text-muted-foreground text-xs">
                                Gunakan nama PERSIS seperti yang teregister di tab "Seluruh OPD" — pisahkan dengan ", " bila lebih dari satu OPD
                                terlibat.
                            </p>
                        </div>
                    </div>
