 ...
 */
export default function Cetak4({ tahun, periode, periodeOptions, pemerintahKabkota, dataUmum, canEdit, narasi, komite }: PageProps) {
    ...
    return (
        <AppLayout>
            ...
            <div className="space-y-4 p-4 print:hidden">
                    ...
                    <div className="flex flex-wrap items-end gap-2">
                        <div className="space-y-1">
                            ...
                            <input
                                type="number"
                                value={tahun}
                                onChange={(e) => router.get('/cetak/laporan/4', { tahun: e.target.value, periode }, { preserveState: true })}
                ...
                {komite.length === 0 && canEdit && (
                    <p className="rounded-md border border-amber-500/60 bg-amber-50 p-3 text-xs text-amber-900 dark:bg-amber-950/30 dark:text-amber-200">
                        Susunan Komite Pengelolaan Risiko tahun {tahun} belum direkam, sehingga blok tanda tangan memakai Kepala Daerah. Rekam di Form
                        Cetak &rarr; Struktur Pengelolaan Risiko dengan peran Komite Pengelolaan Risiko.
                    </p>
                )}
            </div>
            ...
            <div className="cee-print-sheet mx-auto max-w-[1500px] bg-white p-8 text-black print:m-0 print:max-w-none print:p-0 print:shadow-none">
                ...
                <h2 className="mt-2 text-center text-sm font-bold uppercase">Laporan {periodeLabel} Komite Pengelolaan Risiko</h2>
                ...
                <h3 className="mt-4 text-xs font-bold uppercase">C. Hasil Pembinaan terhadap Pengelolaan Risiko Pemerintah Daerah</h3>
                <NarasiSection
                    label=""
                ...
                <MultiPenandatangan
                    ...
                    kepalaJabatan={ketuaKomite?.jabatan ?? dataUmum?.jabatan_kepala_daerah ?? 'Ketua Komite Pengelolaan Risiko'}
                    kepalaNip={null}
