...
export default function Cetak1({ opdOptions, opd, tahun, periode, pemerintahKabkota, dataUmum, ringkasanRisiko, canEdit, narasi }: PageProps) {
    ...
    return (
        <AppLayout>
            ...
            <div className="space-y-4 p-4 print:hidden">
                <div>
                    <h1 className="text-xl font-semibold tracking-tight md:text-2xl">11_Laporan Pelaksanaan Penilaian Risiko</h1>
                    <p className="text-muted-foreground text-sm">Pratinjau cetak ukuran A4 portrait — Tahun {tahun}.</p>
                </div>
            ...
            <div className="cee-print-sheet mx-auto max-w-[1500px] bg-white p-8 text-black print:m-0 print:max-w-none print:p-0 print:shadow-none">
                ...
                <p className="mt-1 text-xs">
                    Ringkasan hasil identifikasi dan analisis risiko (rincian lengkap lihat Form Cetak 3a/3b/3c dan Form 4/5):
                </p>
                ...
                <NarasiSection
                    label=""
                    value={form.data.rancangan_informasi_komunikasi}
                    editing={editing}
                    onChange={(v) => form.setData('rancangan_informasi_komunikasi', v)}
                />

                <h3 className="mt-4 text-xs font-bold uppercase">V. Rancangan Pemantauan</h3>
                <NarasiSection
                    label=""
                    value={form.data.rancangan_pemantauan}
                    editing={editing}
                    onChange={(v) => form.setData('rancangan_pemantauan', v)}
                />
