    ...
    return (
        <table className="mt-2 w-full table-fixed border-collapse border border-black text-[10px]">
            ...
            <tbody>
                {rows.length === 0 && (
                    <tr>
                        <td colSpan={5} className="text-muted-foreground border border-black p-2 text-center">
    ...
    return (
        <AppLayout>
            ...
            <div className="cee-print-sheet mx-auto max-w-[1500px] bg-white p-8 text-black print:m-0 print:max-w-none print:p-0 print:shadow-none">
                ...
                <h2 className="mt-2 text-center text-sm font-bold uppercase">Laporan Triwulan {triwulan} Pengelolaan Risiko</h2>
                ...
                <p className="mt-3 text-xs">
                    Status Progress {opd ? `${opd.nama}` : 'seluruh OPD'} pada Triwulan {triwulan}:
                </p>
