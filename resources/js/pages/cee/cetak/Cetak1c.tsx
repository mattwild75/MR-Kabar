    ...
    return (
        <AppLayout>
            ...
            <div className="space-y-4 p-4 print:hidden">
                <div>
                    <h1 className="text-xl font-semibold tracking-tight md:text-2xl">Form 1c — Simpulan Survei Persepsi</h1>
                ...
                <div className="flex flex-wrap items-end justify-between gap-3">
                    ...
                    {opd && <UnduhPdfButton href={`/cetak/cee/1c/pdf?opd_id=${opd.id}&tahun=${tahun}`} />}
                </div>
            </div>
            ...
            {opd && (
                <div className="cee-print-sheet mx-auto max-w-4xl bg-white p-8 text-black print:m-0 print:max-w-none print:p-0 print:shadow-none">
                    ...
                    <h2 className="mt-2 text-center text-sm font-bold uppercase">Simpulan Survei Persepsi atas Lingkungan Pengendalian Intern</h2>
                    ...
                    <table className="mt-3 w-full border-collapse border border-black text-xs">
                        <thead>
                            <tr>
                                ...
                                <th className="w-28 border border-black p-1" rowSpan={2}>
                                    Sub Unsur
                                </th>
                                ...
                                <th className="w-16 border border-black p-1" rowSpan={2}>
                                    Simpulan
                                </th>
                    ...
                    <div className="mt-4 text-[10px] leading-tight">
                        ...
                        <p>
                            Kolom g diisi dengan simpulan sesuai hasil penilaian awal dan survei persepsi, jika hasil antara penilaian awal dan survei
                            persepsi bertentangan, maka lakukan pendalaman atau lakukan professional judgement untuk menyimpulkannya
                        </p>
                        <p>Kolom h diisi dengan uraian kelemahan</p>
                        {rows.some((r) => r.bertentangan && r.simpulan) && (
                            <p className="mt-1">
                                *) Hasil penilaian awal dan survei persepsi pada sub unsur ini bertentangan, sehingga simpulannya ditarik melalui
                                pendalaman atau professional judgement sebagaimana diuraikan pada kolom h.
                            </p>
                        )}
                    </div>
                </div>
