...
function EntryRow({
    ...
    const [tahunRealisasi, setTahunRealisasi] = useState(entry.tahun_realisasi_penyelesaian ? String(entry.tahun_realisasi_penyelesaian) : '');
    ...
    const editUnsurOptions = unsurOptions.some((u) => u.id === entry.unsur.id) ? unsurOptions : [...unsurOptions, entry.unsur];
        ...
        return (
            <div className="space-y-3 p-4">
                ...
                <Textarea
                    ...
                    placeholder="Kondisi Lingkungan Pengendalian yang Kurang Memadai"
                />
        ...
        <div className="flex items-start gap-3 p-4">
            <div className="min-w-0 flex-1 space-y-1">
                <Badge variant="outline">
                    {entry.unsur.kode}. {entry.unsur.nama}
                </Badge>
                ...
                {entry.submitted_by && (
                    <p className="text-muted-foreground text-xs">Diisi oleh {entry.submitted_by.name || entry.submitted_by.username}</p>
                )}
            </div>
            {canEdit && (
                    ...
                    <>
                            ...
                            <CardContent>
                                <form onSubmit={submit} className="space-y-4">
                                    <div className="space-y-1">
                                        ...
                                        {errors.cee_unsur_id && <p className="text-destructive text-sm">{errors.cee_unsur_id}</p>}
                                    </div>
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-muted-foreground text-xs">
                                            Terisi otomatis dari Penjelasan Simpulan 1c — boleh disunting bila perlu.
                                        </p>
                                        {errors.kondisi_kurang_memadai && <p className="text-destructive text-sm">{errors.kondisi_kurang_memadai}</p>}
                                    </div>
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        {errors.rencana_tindak_pengendalian && (
                                            <p className="text-destructive text-sm">{errors.rencana_tindak_pengendalian}</p>
                                        )}
                                    </div>
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        />
                                        {errors.penanggung_jawab && <p className="text-destructive text-sm">{errors.penanggung_jawab}</p>}
                                    </div>
                        ...
                        <Card>
                            ...
                            <CardContent className="p-0">
                                {entries.length === 0 ? (
                                    <p className="text-muted-foreground p-4 text-sm">Belum ada RTP.</p>
                                ) : (
