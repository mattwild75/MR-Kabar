                ...
                {!opdId ? (
                    ...
                    <form onSubmit={submit} className="space-y-4">
                        <Card>
                            ...
                            <CardContent className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                <div className="space-y-1">
                                    ...
                                    />
                                    {errors.responden_nama && <p className="text-destructive text-sm">{errors.responden_nama}</p>}
                                </div>
                                <div className="space-y-1">
                                    <div className="flex items-center gap-1.5">
                                    ...
                                    />
                                    {errors.responden_jabatan && <p className="text-destructive text-sm">{errors.responden_jabatan}</p>}
                                </div>
                            </CardContent>
                        </Card>
                                    ...
                                    {respondenList.map((r, i) => (
                                        <div key={i} className="flex flex-wrap items-center justify-between gap-2 rounded-md border p-2 text-sm">
                                            <div>
                                                ...
                                                <p className="text-muted-foreground text-xs">{r.jabatan}</p>
                                            </div>
                                                        ...
                                                        <AlertDialog>
                                                            ...
                                                            <AlertDialogContent>
                                                                <AlertDialogHeader>
                                                                    ...
                                                                    <AlertDialogDescription>
                                                                        Seluruh jawaban kuesioner responden ini utk OPD & tahun ini akan dihapus (bisa
                        ...
                        <div className="text-muted-foreground flex items-center gap-1.5 text-sm">
                            <span>
                                Terjawab {totalTerjawab} dari {totalPertanyaan} pertanyaan.
                            </span>
                                        ...
                                        return (
                                            <div key={p.id} className="space-y-2 rounded-md border p-3">
                                                        ...
                                                        <button
                                                            ...
                                                            className={`flex items-center gap-1 rounded-md border px-3 py-1.5 text-sm transition-colors ${
                                                                data.jawaban[p.id] === s.value
                                                                    ? 'border-primary bg-primary text-primary-foreground ring-primary ring-offset-background ring-2 ring-offset-2'
                                                                    : 'hover:bg-muted'
                                                            }`}
                                                        >
                                                ...
                                                {r && r.responden.length > 0 && (
                                                    <div className="text-muted-foreground flex flex-wrap items-center gap-2 border-t pt-2 text-xs">
                                                        <span>
                                                            {r.responden.length} responden telah menjawab · Modus: {r.modus}
                                                        </span>
