    ...
    return (
        <div className="flex items-start gap-3 p-4">
            <div className="min-w-0 flex-1 space-y-1">
                ...
                <p className="text-muted-foreground text-sm">{entry.uraian_kelemahan}</p>
                    ...
                    <>
                                ...
                                <form onSubmit={submit} className="space-y-4">
                                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        <div className="space-y-1">
                                            ...
                                            <Input
                                                id="pengisi_nama"
                                                value={data.pengisi_nama}
                                                onChange={(e) => setData('pengisi_nama', e.target.value)}
                                            />
                                            {errors.pengisi_nama && <p className="text-destructive text-sm">{errors.pengisi_nama}</p>}
                                        </div>
                                        <div className="space-y-1">
                                            <div className="flex items-center gap-1.5">
                                            ...
                                            />
                                            {errors.pengisi_jabatan && <p className="text-destructive text-sm">{errors.pengisi_jabatan}</p>}
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        />
                                        {errors.sumber_data && <p className="text-destructive text-sm">{errors.sumber_data}</p>}
                                    </div>
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        />
                                        {errors.uraian_kelemahan && <p className="text-destructive text-sm">{errors.uraian_kelemahan}</p>}
                                    </div>
                        ...
                        <Card>
                            ...
                            <CardContent className="p-0">
                                {entries.length === 0 ? (
                                    <p className="text-muted-foreground p-4 text-sm">Belum ada entri.</p>
                                ) : (
