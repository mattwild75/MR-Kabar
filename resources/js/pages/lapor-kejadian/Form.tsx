                            ...
                            <div className="space-y-2">
                                ...
                                {!risikoTerpilih ? (
                                    <div className="relative">
                                        ...
                                        />
                                        {searching && <p className="text-muted-foreground mt-1 text-xs">Mencari...</p>}
                                        {hasil.length > 0 && (
                                            <div className="bg-popover absolute z-50 mt-1 max-h-64 w-full overflow-y-auto rounded-md border shadow-md">
                                                {hasil.map((r) => (
                                                    <button
                                                        ...
                                                        className="hover:bg-accent block w-full border-b px-3 py-2 text-left text-sm last:border-b-0"
                                                    >
                                    ...
                                    <div className="border-primary bg-primary/5 flex items-start justify-between gap-2 rounded-md border p-3">
                        ...
                        <CardContent className="space-y-4">
                            <div className="grid gap-4 sm:grid-cols-2">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    {errors.no_hp && <p className="text-destructive text-sm">{errors.no_hp}</p>}
                                </div>
                                <div className="space-y-1.5">
                                    <div className="flex items-center gap-1.5">
                                    ...
                                    {errors.opd_id && <p className="text-destructive text-sm">{errors.opd_id}</p>}
                                </div>
                            </div>
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Textarea
                                    ...
                                    required
                                />
                                {errors.kejadian && <p className="text-destructive text-sm">{errors.kejadian}</p>}
                            </div>
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                                <div className="space-y-1.5">
                                    ...
                                    {errors.waktu_kejadian && <p className="text-destructive text-sm">{errors.waktu_kejadian}</p>}
                                </div>
                                <div className="space-y-1.5">
                                    <div className="flex items-center gap-1.5">
                                    ...
                                    {errors.tempat && <p className="text-destructive text-sm">{errors.tempat}</p>}
                                </div>
                            </div>
