    ...
    return (
        <div className="mt-4">
          ...
          className tr di bawah) yg dijaga agar tidak terpotong di tengah. */}
            <p className="break-after-avoid bg-black px-2 py-1 text-[10px] font-bold text-white uppercase">
                Misi {urutan}
...
export default function CetakProgramBupatiRisiko({
    tahun,
    periode,
    pemerintahKabkota,
    dataUmum,
    programs,
    totalRisikoTerpetakan,
    visiMisiPemda,
}: PageProps) {
                ...
                <table className="mt-4 w-full border-collapse text-xs">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="py-0.5">
                                : {totalRisikoTerpetakan} risiko ({totalPrioritas} kaitan risiko prioritas)
                            </td>
                        </tr>
                    </tbody>
                </table>
