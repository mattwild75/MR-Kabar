            ...
            <DialogContent className="sm:max-w-lg">
                <form onSubmit={submit}>
                    <DialogHeader>
                        ...
                        <DialogDescription>Sampaikan bug, error, atau saran. Laporan Anda akan ditinjau oleh admin.</DialogDescription>
                    </DialogHeader>

                    <div className="space-y-4 py-4">
                        <div>
                            <Label htmlFor="ts-subject" className="mb-2 block">
                                Subjek
                            </Label>
                            <Input
                                id="ts-subject"
                        ...
                        <div>
                            <Label htmlFor="ts-category" className="mb-2 block">
                                Kategori
                            </Label>
                        ...
                        <div>
                            <Label htmlFor="ts-description" className="mb-2 block">
                                Deskripsi
                            </Label>
                            <Textarea
                                id="ts-description"
