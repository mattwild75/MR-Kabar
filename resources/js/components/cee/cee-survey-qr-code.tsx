    ...
    return (
        <div className="flex flex-col items-center gap-3 rounded-md border bg-white p-4 sm:flex-row sm:items-start">
            ...
            <div className="space-y-1.5 text-sm text-neutral-700">
                ...
                <p>Pindai kode QR ini dengan kamera HP untuk langsung membuka Form 1a_Kuesioner CEE — tanpa perlu login manual.</p>
                ...
                <p className="text-xs text-neutral-500">
                    Akun bersama: <code className="rounded bg-neutral-100 px-1">CEE_Survey</code> — dipakai bergantian oleh responden lintas-OPD untuk
                    mengisi kuesioner CEE (Form 1a/1b/1c/1d), tanpa akses ke menu lain.
                </p>
            </div>
        </div>
    );
