        ...
        <AlertDialog open={tampil}>
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        Demi keamanan, sesi berakhir otomatis pada waktu yang tetap sejak Anda masuk — hitungannya berjalan terus, dipakai bekerja
                        maupun ditinggalkan. Pilih <strong>Lanjutkan</strong> untuk tetap masuk tanpa mengetik sandi, atau <strong>Keluar</strong>{' '}
                        sekarang.
                        <span className="text-foreground mt-2 block font-mono text-lg font-semibold">
