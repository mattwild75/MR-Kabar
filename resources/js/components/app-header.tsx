...
const activeItemStyles = 'bg-primary/10 text-foreground';
...
export function AppHeader({ breadcrumbs = [] }: AppHeaderProps) {
    ...
    return (
        <>
            <div className="border-border/80 border-b bg-background/95 backdrop-blur">
                <div className="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                    ...
                    <div className="lg:hidden">
                        <Sheet>
                            ...
                            <SheetContent side="left" className="flex h-full w-64 flex-col items-stretch justify-between bg-background">
                                    ...
                                    <div className="flex h-full flex-col justify-between text-sm">
                                        <div className="flex flex-col space-y-4">
                                            {mainNavItems.map((item) => (
                                                <Link key={item.title} href={item.url} className="flex items-center space-x-2 font-medium text-foreground">
            ...
            {breadcrumbs.length > 1 && (
                <div className="border-border/70 flex w-full border-b bg-background/80">
