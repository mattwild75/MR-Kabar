...
Tidak yakin kategorinya apa? Pilih yang paling mendekati saja, atau kosongkan — PIC OPD akan meninjau ulang laporan Anda.`,
  ...
  cari_risiko_terdaftar: `Ketik kata kunci untuk mencari apakah kejadian yang ingin Anda laporkan sudah pernah tercatat sebagai risiko di sistem — bisa cari lewat uraian risikonya, nama OPD terkait, nama pejabat pemilik/penanggung jawab risiko tersebut, supaya lebih mudah menemukan risiko yang relevan meski Anda tidak tahu persis uraiannya. Kalau ketemu, laporan Anda akan otomatis dikaitkan ke risiko tsb, membantu PIC OPD menelusuri riwayatnya. Kalau tidak ketemu, pilih "Lapor Kejadian Baru" di atas dan isi form seperti biasa.`,
};
