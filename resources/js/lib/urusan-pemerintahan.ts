...
export const URUSAN_PEMERINTAHAN: KelompokUrusan[] = [
  {
    ...
    urusan: [
      {
        nama: 'Pendidikan',
        sub: ['Manajemen Pendidikan', 'Kurikulum', 'Akreditasi', 'Pendidik dan Tenaga Kependidikan', 'Perizinan Pendidikan', 'Bahasa dan Sastra'],
      },
      {
        nama: 'Kesehatan',
        sub: ['Upaya Kesehatan', 'Sumber Daya Manusia (SDM) Kesehatan', 'Sediaan Farmasi, Alat Kesehatan, dan Makanan Minuman', 'Pemberdayaan Masyarakat Bidang Kesehatan'],
      },
      {
        nama: 'Pekerjaan Umum dan Penataan Ruang',
        sub: ['Sumber Daya Air (SDA)', 'Air Minum', 'Persampahan', 'Air Limbah', 'Drainase', 'Permukiman', 'Bangunan Gedung', 'Penataan Bangunan dan Lingkungannya', 'Jalan', 'Jasa Konstruksi', 'Penataan Ruang'],
      },
      {
      ...
      {
        nama: 'Sosial',
        sub: ['Pemberdayaan Sosial', 'Penanganan Warga Negara Migran Korban Tindak Kekerasan', 'Rehabilitasi Sosial', 'Perlindungan dan Jaminan Sosial', 'Penanganan Bencana', 'Taman Makam Pahlawan'],
      },
    ],
  },
  {
    ...
    urusan: [
      { nama: 'Tenaga Kerja', sub: ['Pelatihan Kerja dan Produktivitas Tenaga Kerja', 'Penempatan Tenaga Kerja', 'Hubungan Industrial', 'Pengawasan Ketenagakerjaan'] },
      { nama: 'Pemberdayaan Perempuan dan Pelindungan Anak', sub: ['Kualitas Hidup Perempuan', 'Perlindungan Perempuan', 'Kualitas Keluarga', 'Sistem Data Gender dan Anak', 'Pemenuhan Hak Anak (PHA)', 'Perlindungan Khusus Anak'] },
      ...
      { nama: 'Lingkungan Hidup', sub: ['Kajian Lingkungan Hidup Strategis (KLHS)', 'Keanekaragaman Hayati (Kehati)', 'Pendidikan, Pelatihan, dan Penyuluhan'] },
      ...
      { nama: 'Koperasi, Usaha Kecil, dan Menengah', sub: ['Badan Hukum Koperasi', 'Izin Usaha Simpan Pinjam', 'Penilaian Kesehatan KSP/USP Koperasi', 'Pendidikan dan Latihan Perkoperasian'] },
      { nama: 'Penanaman Modal', sub: ['Pengembangan Iklim Penanaman Modal', 'Kerja Sama Penanaman Modal', 'Promosi Penanaman Modal', 'Pelayanan Penanaman Modal', 'Pengendalian Pelaksanaan Penanaman Modal', 'Data dan Sistem Informasi Penanaman Modal'] },
  ...
  },
  {
    ...
    urusan: [
      ...
      { nama: 'Pertanian', sub: ['Sarana Pertanian', 'Prasarana Pertanian', 'Kesehatan Hewan dan Kesehatan Masyarakat Veteriner', 'Perizinan Usaha Pertanian', 'Karantina Pertanian'] },
      ...
      { nama: 'Perdagangan', sub: ['Perizinan dan Pendaftaran Perusahaan', 'Stabilisasi Harga Barang Kebutuhan', 'Standardisasi dan Perlindungan Konsumen'] },
...
export const DAFTAR_URUSAN: string[] = URUSAN_PEMERINTAHAN.flatMap((k) =>
  k.urusan.map((u) => u.nama),
);
 ...
 * berbeda dari daftar.
 */
export const DAFTAR_SUB_URUSAN: string[] = [
  ...new Set(URUSAN_PEMERINTAHAN.flatMap((k) => k.urusan.flatMap((u) => u.sub))),
