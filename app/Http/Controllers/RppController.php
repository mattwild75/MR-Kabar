...
class RppController extends Controller
{
        ...
        return [
            'rpp' => $rpp ? [
                ...
                'penugasan' => $rpp->penugasan->map(fn (RppPenugasan $p) => [
                    ...$p->only(['urutan', 'uraian', 'sifat', 'lokasi', 'jumlah_laporan', 'tmt_teks', 'nomor_sp', 'nomor_st', 'nomor_kp', 'capaian_output', 'status']),
            ...
            'tarifLuarKota' => (int) RppSetting::current()->tarif_luar_kota,
            'kecamatanLuar' => RppPenugasan::KECAMATAN_LUAR,
    ...
    private function validasi(Request $request, ?int $abaikanId = null): array
    {
        $v = $request->validate([
            ...
            'penugasan.*.lokasi' => ['nullable', Rule::in(['dalam', 'luar'])],
