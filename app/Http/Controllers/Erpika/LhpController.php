    ...
    private function detail(Lhp $lhp): array
    {
        return [
            ...
            'temuan' => $lhp->temuan->map(fn ($t) => [
                ...
                'kode_label' => KodeLhp::label('temuan', $t->kode),
                ...
                'sebab' => $t->sebab->map(fn ($s) => [
                    ...
                    'kode_label' => KodeLhp::label('sebab', $s->kode),
                    'memo' => $s->memo,
                    'rekomendasi' => $s->rekomendasi->map(fn ($r) => [
                        ...
                        'kode' => $r->kode,
                        'group_label' => KodeLhp::label('group_rekomendasi', $r->kode_group),
                        'kode_label' => KodeLhp::label('rekomendasi', $r->kode),
                        ...
                        'tindak_lanjut' => $r->tindakLanjut->map(fn ($tl) => [
                            ...
                            'kode' => $tl->kode,
                            'group_label' => KodeLhp::label('group_tl', $tl->kode_group),
                            'kode_label' => KodeLhp::label('tl', $tl->kode),
