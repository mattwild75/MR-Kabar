    ...
    public function run(): void
    {
        ...
        if (IrsPemda::where('user_id', $user->id)->exists()) {
            ...
            IrsPemda::create([
                ...
                'URAIAN PENYEBAB RISIKO' => 'Method (Belum ada forum koordinasi rutin lintas-OPD yang secara berkala meninjau konsistensi seluruh Perkada/SE yang berlaku terhadap capaian target RPJMD)',
                ...
                'RENCANA TINDAK PENGENDALIAN' => 'Mitigate (Membangun forum koordinasi triwulanan lintas-OPD untuk meninjau konsistensi Perkada/SE yang berlaku terhadap capaian target RPJMD, difasilitasi Sekretariat Daerah)',
        ...
        if (IrsPd::where('user_id', $user->id)->exists()) {
            ...
            IrsPd::create([
                ...
                'URAIAN PENYEBAB RISIKO' => 'Method (OPD teknis pengusul belum menggunakan template baku rancangan produk hukum dan minim pemahaman kaidah legal drafting)',
                ...
                'RENCANA TINDAK PENGENDALIAN' => 'Mitigate (Menyelenggarakan pelatihan legal drafting bagi staf OPD teknis pengusul produk hukum minimal sekali setahun, serta mewajibkan penggunaan template baku)',
                'UNIT/OPD PENANGGUNG JAWAB PENGENDALIAN' => 'Sekretariat Daerah',
        ...
        if (IroPd::where('user_id', $user->id)->exists()) {
            ...
            IroPd::create([
                ...
                'TAHAP' => 'Pelaporan',
                'PEMILIK RISIKO' => 'Kepala Bagian Hukum Sekretariat Daerah',
                'URAIAN PENYEBAB RISIKO' => 'Method (Antrean penomoran produk hukum menumpuk di akhir tahun anggaran bersamaan dengan banyak usulan lain)',
                ...
                'RENCANA TINDAK PENGENDALIAN' => 'Mitigate (Menetapkan kriteria prioritas penomoran berbasis urgensi program dan menerapkan SLA maksimal 3 hari kerja sejak harmonisasi selesai)',
                'UNIT/OPD PENANGGUNG JAWAB PENGENDALIAN' => 'Sekretariat Daerah',
