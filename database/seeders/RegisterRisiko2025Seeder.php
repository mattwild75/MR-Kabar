        ...
        return [
            'DINAS SOSIAL' => [
                ...
                'irs_pemda' => [
                    ...
                    'SUMBER SEBAB RISIKO' => 'Internal (Data sebaran Kelompok Rentan antar Kecamatan belum terkonsolidasi di tingkat Pemda)',
                    'C / UC' => 'C (Pemetaan dan alokasi kuota sepenuhnya dapat diatur ulang secara internal Pemda)',
                ...
                'irs_pd' => [
                    ...
                    'SUMBER SEBAB RISIKO' => 'Internal (Belum ada mekanisme penonaktifan otomatis data DTKS versi lama pasca pemutakhiran)',
                    'C / UC' => 'C (Mekanisme penonaktifan data lama dapat dibangun secara internal oleh Dinas Sosial)',
                ...
                'iro_pd' => [
                    ...
                    'SUMBER SEBAB RISIKO' => 'Eksternal (Keterbatasan infrastruktur telekomunikasi di wilayah kerja)',
                    'C / UC' => 'UC (Ketersediaan jaringan internet di luar kendali langsung Dinas Sosial)',
            ...
            'INSPEKTORAT' => [
                ...
                'irs_pemda' => [
                    ...
                    'SUMBER SEBAB RISIKO' => 'Internal (Belum ada sistem pemantauan tindak lanjut rekomendasi pengawasan terintegrasi lintas-OPD)',
                    'C / UC' => 'C (Sistem pemantauan dapat dibangun secara internal oleh Inspektorat)',
                ...
                'irs_pd' => [
                    ...
                    'SUMBER SEBAB RISIKO' => 'Internal (Perencanaan kaderisasi jabatan fungsional Auditor/P2UPD belum optimal)',
                    'C / UC' => 'C (Perencanaan kaderisasi sepenuhnya dapat diatur ulang secara internal Inspektorat)',
                ...
                'iro_pd' => [
                    ...
                    'SUMBER SEBAB RISIKO' => 'Internal (Penyusunan PKPT belum mengalokasikan buffer waktu untuk penugasan tak terduga)',
                    'C / UC' => 'C (Penyusunan PKPT sepenuhnya kewenangan internal Inspektorat)',
            ...
            'BLUD RSUD CUT NYAK DHIEN' => [
                ...
                'irs_pemda' => [
                    ...
                    'SUMBER SEBAB RISIKO' => 'Internal (Interoperabilitas sistem rekam medis antar fasilitas kesehatan Pemda belum terbangun)',
                    'C / UC' => 'C (Integrasi sistem rekam medis sepenuhnya dapat dibangun oleh Pemda melalui Dinas Kesehatan dan RSUD)',
                ...
                'irs_pd' => [
                    ...
                    'SUMBER SEBAB RISIKO' => 'Internal (Pencatatan status tempat tidur masih manual oleh perawat ruangan, dilaporkan berkala bukan real-time)',
                    'C / UC' => 'C (Pembangunan sistem bed management sepenuhnya kewenangan internal RSUD)',
                ...
                'iro_pd' => [
                    ...
                    'SUMBER SEBAB RISIKO' => 'Internal (Perencanaan kebutuhan obat vital masih berbasis estimasi kasar, belum berbasis data konsumsi)',
                    'C / UC' => 'C (Penetapan reorder point sepenuhnya kewenangan internal RSUD)',
            ...
            'DINAS KESEHATAN' => [
                ...
                'irs_pemda' => [
                    ...
                    'SUMBER SEBAB RISIKO' => 'Internal (Penetapan lokus intervensi stunting oleh masing-masing OPD dilakukan terpisah tanpa forum konvergensi bersama)',
                    'C / UC' => 'C (Forum konvergensi sepenuhnya dapat dibangun secara internal Pemda)',
                ...
                'irs_pd' => [
                    ...
                    'SUMBER SEBAB RISIKO' => 'Eksternal (Keandalan pasokan listrik PLN di wilayah pesisir di luar kendali Dinas Kesehatan)',
                    'C / UC' => 'UC (Stabilitas pasokan listrik merupakan kewenangan PLN, di luar kendali langsung Dinas Kesehatan)',
                ...
                'iro_pd' => [
                    ...
                    'SUMBER SEBAB RISIKO' => 'Eksternal (Kondisi geografis dan aksesibilitas wilayah di luar kendali langsung Dinas Kesehatan)',
                    'C / UC' => 'UC (Kondisi geografis merupakan faktor eksternal di luar kendali Dinas Kesehatan)',
            ...
            'SEKRETARIAT DAERAH' => [
                ...
                'irs_pemda' => [
                    ...
                    'SUMBER SEBAB RISIKO' => 'Internal (Mekanisme penyampaian pagu indikatif awal sebelum Musrenbang kecamatan belum berjalan konsisten)',
                    'C / UC' => 'C (Mekanisme penyampaian pagu indikatif sepenuhnya dapat diatur ulang secara internal Pemda)',
                ...
                'irs_pd' => [
                    ...
                    'SUMBER SEBAB RISIKO' => 'Internal (Belum ada sistem dokumentasi rapat terpusat yang dapat diakses bersama)',
                    'C / UC' => 'C (Pembangunan sistem dokumentasi terpusat sepenuhnya kewenangan internal Sekretariat Daerah)',
                ...
                'iro_pd' => [
                    ...
                    'SUMBER SEBAB RISIKO' => 'Internal (Belum ada SOP pelaporan monitoring capaian program yang mengikat seluruh Kecamatan)',
                    'C / UC' => 'C (Penetapan SOP dan tenggat waktu pelaporan sepenuhnya kewenangan internal Sekretariat Daerah)',
